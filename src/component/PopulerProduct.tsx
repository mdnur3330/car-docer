...
export default function PopulerProduct() {
    const items = [
        { img: "/assets/images/products/1.png", title: "LED Headlight", price: "$120" },
        { img: "/assets/images/products/2.png", title: "Car Air Filter", price: "$45" },
        { img: "/assets/images/products/3.png", title: "Spark Plug", price: "$35" },
        { img: "/assets/images/products/4.png", title: "Car Battery 12V", price: "$150" },
        { img: "/assets/images/products/5.png", title: "Alloy Wheels", price: "$300" },
        { img: "/assets/images/products/6.png", title: "Car Brake Pads", price: "$80" },
    ]
    ...
    return (
        <div>
            <Container>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6 justify-center'>
                    {items.map((i, index) => (
                        <div key={index} className='shadow space-y-3'>
                            <Image
                                src={i.img}
                                width={96}
                                height={66}
                                alt={i.title}
                                className='bg-base-200 mx-auto bg-[#F3F3F3] w-60 h-52 p-10 rounded-lg'
                            />
                            <div className='text-center py-2'>
                                <h3>{i.title}</h3>
                                <h3 className='text-xl font-bold text-[#FF3811]'>{i.price}</h3>
